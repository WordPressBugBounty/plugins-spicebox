...
//Page editor Section
$wp_customize->add_section('busicare_gutenberg_editor_section',array(
...
class Busicare_Editor_Customize_Control extends WP_Customize_Control {
    ...
    public function render_content() {
        ...
        ?>
        <div class="busicare-features-customizer">
            <p>Use this button to insert Gutenberg blocks into the Business Template page.</p>
            <a href="<?php echo esc_url($edit_link); ?>" class="busicare-button button-primary">
...
$wp_customize->add_control( 
    new Busicare_Editor_Customize_Control( 
        $wp_customize, 
        'edit_homepage_button_setting', 
        array(
            'section' => 'busicare_gutenberg_editor_section',
