...
$wp_customize->selective_refresh->add_partial('home_slider_btn_txt2', array(
 ...
 //Page editor Section
    $wp_customize->add_section('spice_software_gutenberg_editor_section',array(
    ...
    class Spice_Software_Editor_Customize_Control extends WP_Customize_Control {
        ...
        public function render_content() {
            ...
            ?>
            <div class="spice-software-features-customizer">
                <p>Use this button to insert Gutenberg blocks into the Business Template page.</p>
                <a href="<?php echo esc_url($edit_link); ?>" class="spice-software-button button-primary">
    ...
    $wp_customize->add_control( 
        new Spice_Software_Editor_Customize_Control( 
            $wp_customize, 
            'edit_homepage_button_setting', 
            array(
                'section' => 'spice_software_gutenberg_editor_section',
