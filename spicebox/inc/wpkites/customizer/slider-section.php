...
//Page editor Section
$wp_customize->add_section('wpkites_gutenberg_editor_section',array(
...
class Wpkites_Editor_Customize_Control extends WP_Customize_Control {
    ...
    public function render_content() {
        ...
        ?>
        <div class="wpkites-features-customizer">
            <p>Use this button to insert Gutenberg blocks into the Business Template page.</p>
            <a href="<?php echo esc_url($edit_link); ?>" class="wpkites-button button-primary">
...
$wp_customize->add_control( 
    new Wpkites_Editor_Customize_Control( 
        $wp_customize, 
        'edit_homepage_button_setting', 
        array(
            'section' => 'wpkites_gutenberg_editor_section',
