...
function spiceb_wpkites_news_section()
{
    ...
    wp_register_script('wpkites-blog', SPICEB_PLUGIN_URL . 'inc/wpkites/js/front-page/blog.js', array('jquery'), SPICEBOX_PLUGIN_VERSION, true);
                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-xs-12">
                            <div class="section-header">                            
                                ...
                                if ($home_news_section_discription){?><h5 class="section-subtitle"><?php echo wp_kses_post($home_news_section_discription); ?></h5>
                                <?php } ?>
